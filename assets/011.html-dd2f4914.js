...
mov r0, #1
BL func_test
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>此时，第5个参数在调用前被存储在堆栈上</p>`,39);function _(g,A){const l=a("ExternalLinkIcon");return r(),c("div",null,[o,e("p",null,[i("使用IDA工具并设置机器码的显示( Option -> General -> Disassembly -> Number of opcode bytes: 5)。以下两例均来自参考文章"),e("a",v,[i("https://bbs.kanxue.com/thread-268869.htm"),n(l)])]),u,e("ul",null,[e("li",null,[i("说明： "),e("ul",null,[m,e("li",null,[i("R3 加载内存偏移表对应项 "),b,i(" 的地址 "),R,i(" - "),D,e("a",p,[i("https://bbs.kanxue.com/thread-268869.htm"),n(l)])]),h])])]),C])}const x=s(t,[["render",_],["__file","011.html.vue"]]);export{x as default};
