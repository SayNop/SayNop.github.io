import{_ as l,r as t,o,c as r,a as s,b as n,d as e,e as i}from"./app-1332aa1f.js";const c={},d=s("h2",{id:"homebrew",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#homebrew","aria-hidden":"true"},"#"),n(" Homebrew")],-1),p={href:"https://brew.sh/",target:"_blank",rel:"noopener noreferrer"},u=i(`<h3 id="cmake-nvm" tabindex="-1"><a class="header-anchor" href="#cmake-nvm" aria-hidden="true">#</a> cmake nvm</h3><p>通过homebrew安装<code>cmake</code>、<code>nvm</code>等开发工具</p><ul><li>可能会遇到的安装失败</li></ul><div class="macos language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>Searching <span class="token keyword">for</span> similarly named formulae<span class="token punctuation">..</span>. 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="vim配置语法高亮" tabindex="-1"><a class="header-anchor" href="#vim配置语法高亮" aria-hidden="true">#</a> vim配置语法高亮</h2><p>复制默认配置文件<code>cp /usr/share/vim/vimrc ~/.vimrc</code>或<code>cp /usr/share/vim/vimrc /etc/vimrc</code></p><p>编辑配置文件</p><ul><li>增加以下代码实现语法高亮的功能<div class="language-systemd line-numbers-mode" data-ext="systemd"><pre class="language-systemd"><code>&quot; 设置主题
colorscheme desert
&quot; 语法高亮
syntax on
&quot; 查找结果 高亮显示
...
set nocompatible
&quot; 启用backspace
set backspace<span class="token punctuation">=</span><span class="token value attr-value">indent,eol,start</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li><li>直接使用以下配置 (vi 亦可用)<div class="language-systemd line-numbers-mode" data-ext="systemd"><pre class="language-systemd"><code>&quot; 中文乱码
if v:lang <span class="token punctuation">=</span><span class="token value attr-value">~ <span class="token quoted">&quot;utf8$&quot;</span> || v:lang =~ <span class="token quoted">&quot;UTF-8$&quot;</span></span>
    set fileencodings<span class="token punctuation">=</span><span class="token value attr-value">ucs-bom,utf-8,latin1</span>
endif

set nocompatible        &quot; Use Vim defaults (much better!)
set bs<span class="token punctuation">=</span><span class="token value attr-value">indent,eol,start</span>         &quot; allow backspacing over everything in insert mode
&quot;set ai                 &quot; always set autoindenting on
&quot;set backup             &quot; keep a backup file
set viminfo<span class="token punctuation">=</span><span class="token value attr-value">&#39;20,</span>\\&quot;50    &quot; read/write a .viminfo file, don&#39;t store more
                        &quot; than 50 lines of registers
set history<span class="token punctuation">=</span><span class="token value attr-value">50</span>          &quot; keep 50 lines of command line history
...
if has(&quot;autocmd&quot;)
    ...
    &quot; autocmd BufRead *.txt set tw<span class="token punctuation">=</span><span class="token value attr-value">78</span>
    &quot; When editing a file, always jump to the last cursor position
    autocmd BufReadPost *
    \\ if line(&quot;&#39;\\&quot;&quot;) &gt; 0 &amp;&amp; line (&quot;&#39;\\&quot;&quot;) &lt;<span class="token punctuation">=</span> <span class="token value attr-value">line(&quot;$&quot;) |</span>
    \\   exe &quot;normal! g&#39;\\&quot;&quot; |
    \\ endif
    &quot; don&#39;t write swapfile on most commonly used directories for NFS mounts or USB sticks
    autocmd BufNewFile,BufReadPre /media/*,/run/media/*,/mnt/* set directory<span class="token punctuation">=</span><span class="token value attr-value">~/tmp,/var/tmp,/tmp</span>
...
if has(&quot;cscope&quot;) &amp;&amp; filereadable(&quot;/usr/bin/cscope&quot;)
    set csprg<span class="token punctuation">=</span><span class="token value attr-value">/usr/bin/cscope</span>
    set csto<span class="token punctuation">=</span><span class="token value attr-value">0</span>
    set cst
    set nocsverb
    ...
    elseif $CSCOPE_DB !<span class="token punctuation">=</span> <span class="token value attr-value"><span class="token quoted">&quot;&quot;</span></span>
        cs add $CSCOPE_DB
    endif
    set csverb
endif
...
if &amp;term<span class="token punctuation">=</span><span class="token value attr-value">=&quot;xterm&quot;</span>
    set t_Co<span class="token punctuation">=</span><span class="token value attr-value">8</span>
    set t_Sb<span class="token punctuation">=</span><span class="token value attr-value">^[[4%dm</span>
    set t_Sf<span class="token punctuation">=</span><span class="token value attr-value">^[[3%dm</span>
endif

&quot; Don&#39;t wake up system with blinking cursor:
&quot; http://www.linuxpowertop.org/known.php
let &amp;guicursor <span class="token punctuation">=</span> <span class="token value attr-value">&amp;guicursor . <span class="token quoted">&quot;,a:blinkon0&quot;</span></span>
~      
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li></ul><h2 id="py3虚拟环境" tabindex="-1"><a class="header-anchor" href="#py3虚拟环境" aria-hidden="true">#</a> py3虚拟环境</h2><p>https://zhuanlan.zhihu.com/p/137624513</p><ul><li>安装虚拟环境与虚拟环境管理</li></ul><div class="macos language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>pip3 <span class="token function">install</span> virtualenv
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="mongo安装" tabindex="-1"><a class="header-anchor" href="#mongo安装" aria-hidden="true">#</a> mongo安装</h2>`,6),g={href:"https://www.mongodb.com/try/download/community-edition",target:"_blank",rel:"noopener noreferrer"},f=s("li",null,"解压数据包并放入对应位置",-1),_=i(`<div class="macos language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">tar</span> <span class="token parameter variable">-zxvf</span> mongodb-osx-ssl-x86_64-x.x.x.tgz
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="docker安装" tabindex="-1"><a class="header-anchor" href="#docker安装" aria-hidden="true">#</a> docker安装</h2>`,6),x={href:"https://docs.docker.com/desktop/get-started",target:"_blank",rel:"noopener noreferrer"},w={href:"https://www.jianshu.com/p/6067a74fca3c",target:"_blank",rel:"noopener noreferrer"},q=i(`<p>如需切换源：在设置中的docker engine选项json中添加配置</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token property">&quot;registry-mirrors&quot;</span><span class="token operator">:</span> <span class="token punctuation">[</span><span class="token string">&quot;https://docker.mirrors.ustc.edu.cn/&quot;</span><span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="redis安装" tabindex="-1"><a class="header-anchor" href="#redis安装" aria-hidden="true">#</a> redis安装</h2>`,3),y={href:"https://redis.io/download/",target:"_blank",rel:"noopener noreferrer"},P=s("li",null,"解压数据包并放入对应位置",-1),A=i(`<div class="macos language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">tar</span> <span class="token parameter variable">-zxvf</span> redis-x.x.x.tar.gz
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>配置文件部分配置项说明 <ul><li><code>bind 127.0.0.1</code> 监听ip，如需远程连接则需取消bind配置项</li><li><code>protected-mode yes</code> 只允许本机连接，如需远程连接则需要设置为<code>no</code></li><li><code>requirepass xxx</code> 设置redis连接密码</li><li><code>dir /var/lib/redis</code> 设置数据库快照文件写入位置</li></ul></li></ul>`,4),O=s("strong",null,"redis的开机启动",-1),R=s("br",null,null,-1),D={href:"http://www.js2node.com/redis-io/install-redis-io-2-4-17-on-mac-osx-as-service",target:"_blank",rel:"noopener noreferrer"},E=i(`<p>给mac添加一个启动项</p><ul><li><p>在 ~/Library/LaunchAgents 目录下自己建立一个 redis.plist</p></li><li><p><code>sudo vim redis.plist</code>输入以下内容</p></li></ul><p>Labelio.redis.redis-serverProgramArguments/usr/local/bin/redis-server/usr/local/etc/redis.confRunAtLoad</p><ul><li><p>执行命令<code>sudo launchctlload/Library/LaunchDaemons/io.redis.redis-server.plist</code></p></li><li><p>打开关闭<code>sudo launchctlstartio.redis.redis-server$ sudo launchctl stop io.redis.redis-server</code></p></li></ul><h2 id="elasticsearch" tabindex="-1"><a class="header-anchor" href="#elasticsearch" aria-hidden="true">#</a> elasticsearch</h2><ul><li>下载并解包</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">wget</span> https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-7.8.0-linux-x86_64.tar.gz
<span class="token function">tar</span> <span class="token parameter variable">-xvf</span> elasticsearch-7.8.0-linux-x86_64.tar.gz <span class="token builtin class-name">.</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>配置java虚拟机，编辑配置 <code>config/jvm.options</code></li></ul><div class="language-systemd line-numbers-mode" data-ext="systemd"><pre class="language-systemd"><code><span class="token comment"># 内存信息</span>
-Xms1g
-Xmx1g

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>配置es，编辑es配置文件<code>elasticsearch-7.8.0/config/elasticseach.yml</code>，常用配置如下</li></ul><div class="language-systemd line-numbers-mode" data-ext="systemd"><pre class="language-systemd"><code><span class="token comment"># 当前节点名称 - 自定义节点名称</span>
node.name: &lt;node_name&gt;
...
<span class="token comment"># # 设置当前的IP地址，通过指定相同网段的其他节点会加入该集群中</span>
network.host: 0.0.0.0
<span class="token comment"># # 设置对外服务的http端口</span>
http.port: 9200

<span class="token comment"># 把当前节点当做集群的主节点 - 内网ip + 自定义节点名称</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>运行。linux下不可使用root用户运行。需要通过<code>useradd elsearch</code>与<code>su - elsearch</code>创建用户</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code> <span class="token builtin class-name">cd</span> elasticsearch-7.8.0/bin
 ./elasticsearch
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="fastdfs安装" tabindex="-1"><a class="header-anchor" href="#fastdfs安装" aria-hidden="true">#</a> fastdfs安装</h2><p>使用docker进行fastdfs的安装</p><ul><li>拉取镜像</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> pull delron/fastdfs
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,27),H=s("li",null,"由于storage容器注册在tracker容器中用的是容器网段ip（172.19.0.1），所以返回给Java服务器端的ip也是该ip，导致服务无法访问。需要将宿主机中请求172.19.0.1的请求都默认为docker中的请求。在客户端访问172.19.0.1:23000时，会转向访问本机的127.0.0.1:23000进入docker中的tracker服务",-1),N=s("strong",null,"macos",-1),z={href:"https://blog.csdn.net/zhujuntiankong/article/details/106864724",target:"_blank",rel:"noopener noreferrer"},T=i(`<div class="macos language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">ifconfig</span> lo0 <span class="token builtin class-name">alias</span> <span class="token number">172.19</span>.0.1
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="参考文章" tabindex="-1"><a class="header-anchor" href="#参考文章" aria-hidden="true">#</a> 参考文章</h2>`,11),j={href:"https://zhuanlan.zhihu.com/p/137624513",target:"_blank",rel:"noopener noreferrer"},S=s("br",null,null,-1),$={href:"https://jingyan.baidu.com/article/fa4125ac0e3c2928ac709204.html",target:"_blank",rel:"noopener noreferrer"},L=s("br",null,null,-1),I={href:"https://www.jianshu.com/p/bb77f8be67f4",target:"_blank",rel:"noopener noreferrer"},V=s("br",null,null,-1),K={href:"https://www.jianshu.com/p/6067a74fca3c",target:"_blank",rel:"noopener noreferrer"},M=s("br",null,null,-1),B={href:"https://yijiebuyi.com/blog/d8ab4b444c16f42cefe30df738a42518.html",target:"_blank",rel:"noopener noreferrer"},U={href:"https://www.jianshu.com/p/6b5eca8d908b",target:"_blank",rel:"noopener noreferrer"},C=s("br",null,null,-1),F={href:"https://blog.csdn.net/zhujuntiankong/article/details/106864724",target:"_blank",rel:"noopener noreferrer"};function W(Q,G){const a=t("ExternalLinkIcon");return o(),r("div",null,[d,s("p",null,[n("复制"),s("a",p,[n("Homebrew官网"),e(a)]),n("的安装命令进行安装（需要良好的网络环境）")]),u,s("ul",null,[s("li",null,[s("a",v,[n("mysql官网"),e(a)]),n("下载所需的社区版本桌面端APP")]),m,b,h]),k,s("ul",null,[s("li",null,[s("a",g,[n("官网"),e(a)]),n("下载所需的社区版本")]),f]),_,s("p",null,[n("参照"),s("a",x,[n("docker官方文档"),e(a)]),n("安装docker桌面端APP")]),s("p",null,[n("具体命令与说明可参考"),s("a",w,[n("相关文章"),e(a)])]),q,s("ul",null,[s("li",null,[s("a",y,[n("redis官网"),e(a)]),n("下载所需版本的redis数据包")]),P]),A,s("p",null,[O,R,n(" 参考："),s("a",D,[n("http://www.js2node.com/redis-io/install-redis-io-2-4-17-on-mac-osx-as-service"),e(a)])]),E,s("ul",null,[H,s("li",null,[N,n("参照命令并建立172的端口映射，"),s("a",z,[n("参考文章"),e(a)]),n("内10开头的端口映射暂时不用。")])]),T,s("p",null,[n("python虚拟环境 "),s("a",j,[n("https://zhuanlan.zhihu.com/p/137624513"),e(a)]),S,n(" mysql安装 "),s("a",$,[n("https://jingyan.baidu.com/article/fa4125ac0e3c2928ac709204.html"),e(a)]),L,n(" mongo安装 "),s("a",I,[n("https://www.jianshu.com/p/bb77f8be67f4"),e(a)]),V,n(" docker命令参考 "),s("a",K,[n("https://www.jianshu.com/p/6067a74fca3c"),e(a)]),M,n(" redis安装 "),s("a",B,[n("https://yijiebuyi.com/blog/d8ab4b444c16f42cefe30df738a42518.html"),e(a)]),s("a",U,[n("https://www.jianshu.com/p/6b5eca8d908b"),e(a)]),C,n(" fastdfs安装 "),s("a",F,[n("https://blog.csdn.net/zhujuntiankong/article/details/106864724"),e(a)])])])}const J=l(c,[["render",W],["__file","003.html.vue"]]);export{J as default};
