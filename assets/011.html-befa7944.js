...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li></ul><h4 id="通过伪指令加载指定数据" tabindex="-1"><a class="header-anchor" href="#通过伪指令加载指定数据" aria-hidden="true">#</a> 通过伪指令加载指定数据</h4>`,26),v={href:"https://bbs.kanxue.com/thread-268869.htm",target:"_blank",rel:"noopener noreferrer"},m=d(`<p><strong>例1</strong> ：以C++程序helloworld代码main函数为例说明如何通过 <strong>伪指令<code>LDR</code>引用字符串常量</strong>。</p><div class="macos language-assembly line-numbers-mode" data-ext="assembly"><pre class="language-assembly"><code>; 目标字符串存放位置
...
mov r0, #1
BL func_test
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>此时，第5个参数在调用前被存储在堆栈上</p>`,17);function L(x,E){const l=a("ExternalLinkIcon");return r(),c("div",null,[o,e("p",null,[i("使用IDA工具并设置机器码的显示( Option -> General -> Disassembly -> Number of opcode bytes: 5)。以下两例均来自参考文章"),e("a",v,[i("https://bbs.kanxue.com/thread-268869.htm"),n(l)]),i("中流程打包构建的 hello_arm 可执行文件在 IDA 中反编译的内容")]),m,e("ul",null,[e("li",null,[i("说明： "),e("ul",null,[u,e("li",null,[i("R3 加载内存偏移表对应项 "),R,i(" 的地址 "),b,i(" - "),D,e("a",p,[i("https://bbs.kanxue.com/thread-268869.htm"),n(l)])]),h])])]),C,e("p",null,[i("在 "),_,i(" 动态调试时，若F7单步执行到某一条指令时（与其他ide类似，卡在将执行的指令上），其实CPU已经开始处理目标指令后面的两条指令了（下一条指令已开始解码，下下条指令已开始读取）。指令窗口中的PC（假PC）指向的是将执行的指令，而寄存器窗口的PC（真PC）值已为下下条指令的地址（参考文章"),e("a",g,[i("https://www.cnblogs.com/dliv3/p/5285771.html"),n(l)]),i("）")]),A])}const B=s(t,[["render",L],["__file","011.html.vue"]]);export{B as default};
